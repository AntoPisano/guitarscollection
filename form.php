...
<body>
<h1 class="addGuitar">Add a new guitar to the collection:</h1>
<div class="container">
<form action="add.php" method="POST">
    <ul>
        <li><input type="text" name="img" placeholder="IMG LINK"></li>
        ...
        <li><input type="text" name="artist" placeholder="PLAYED BY"></li>
    </ul>
    ...
    <a href="http://localhost:1234/collection/guitarscollection/collection.php" class="button">BACK TO THE GUITAR COLLECTION!!</a>

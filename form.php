...
<h1 class="addGuitar">Add a guitar to the collection:</h1>
<div class="container">
<form action="add.php" method="POST">
    <ul>
        <li><input type="text" name="img" placeholder="IMG LINK" formmethod="POST"></li>
        <li><input type="text" name="model" placeholder="MODEL" formmethod="POST"></li>
        <li><input type="text" name="year" placeholder="YEAR" formmethod="POST"></li>
        <li><input type="text" name="type" placeholder="TYPE" formmethod="POST"></li>
